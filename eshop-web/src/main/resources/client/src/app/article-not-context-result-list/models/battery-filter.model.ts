export class BatteryFilter {
    ...
    constructor(data?: any) {
        if (data) {
            ...
            this.ampereHours = data.ampereHour ? [...this.ampereHours, ...data.ampereHour.split(',')] : [];
            this.lengths = data.length ? [...this.lengths, ...data.length.split(',')] : [];
            this.widths = data.width ? [...this.widths, ...data.width.split(',')] : [];
            this.heights = data.height ? [...this.heights, ...data.height.split(',')] : [];

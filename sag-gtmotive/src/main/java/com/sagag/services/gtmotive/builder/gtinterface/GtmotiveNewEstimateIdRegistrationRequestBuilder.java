...
@Data
public class GtmotiveNewEstimateIdRegistrationRequestBuilder implements Serializable {

  private static final String ELE_ITEM_CLOSE = AbstractGtmotiveRequestBuilder.ELE_ITEM_CLOSE;

  private static final String ELE_ITEM_OPEN = AbstractGtmotiveRequestBuilder.ELE_ITEM_OPEN;

  private static final String ATTR_LOCKED_FALSE = AbstractGtmotiveRequestBuilder.ATTR_LOCKED_FALSE;
   ...
   * Default constructor.
   */
  private GtmotiveNewEstimateIdRegistrationRequestBuilder() {
  ...
  public static final class Builder {
    ...
    private GtmotiveVehicleInfoCriteria requestCriteria;

    public Builder(final GtmotiveVehicleInfoCriteria criteria) {
      this.requestCriteria = criteria;
    }

    public GtmotiveNewEstimateIdRegistrationRequestBuilder buildRequest() {
      return new GtmotiveNewEstimateIdRegistrationRequestBuilder(this);
    }
  }
  ...
  private GtmotiveNewEstimateIdRegistrationRequestBuilder(final Builder builder) {
    this();

...
@NamedQuery(name = "DestOfferPosition.findAll", query = "SELECT o FROM DestOfferPosition o")
@Data
public class DestOfferPosition implements Serializable {

  private static final long serialVersionUID = 8965538465259635562L;

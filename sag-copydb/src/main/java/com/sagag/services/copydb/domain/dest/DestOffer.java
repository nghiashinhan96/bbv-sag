...
@Entity
@Table(name = "OFFER")
@NamedQuery(name = "DestOffer.findAll", query = "SELECT o FROM DestOffer o")
@Data
public class DestOffer implements Serializable {

  private static final long serialVersionUID = -1446410381318741175L;

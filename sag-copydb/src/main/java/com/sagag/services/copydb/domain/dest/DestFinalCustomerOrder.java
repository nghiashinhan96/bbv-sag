...
@NamedQuery(name = "DestFinalCustomerOrder.findAll", query = "SELECT f FROM DestFinalCustomerOrder f")
@Data
public class DestFinalCustomerOrder implements Serializable {

...
@NamedQuery(name = "MessageAccessRightRole.findAll", query = "SELECT m FROM MessageAccessRightRole m")
@Data
public class MessageAccessRightRole implements Serializable {

  private static final long serialVersionUID = 3294120387352891837L;

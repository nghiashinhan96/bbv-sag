...
@NamedQuery(name = "DestFinalCustomerOrderItem.findAll", query = "SELECT f FROM DestFinalCustomerOrderItem f")
@Data
public class DestFinalCustomerOrderItem implements Serializable {

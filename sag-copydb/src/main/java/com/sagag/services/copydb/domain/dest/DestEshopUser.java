...
/**
 * The persistent class for the ESHOP_USER database table.
 * 
 */
@Entity
@Table(name = "ESHOP_USER")
@NamedQuery(name = "DestEshopUser.findAll", query = "SELECT e FROM DestEshopUser e")
@Data
public class DestEshopUser implements Serializable {

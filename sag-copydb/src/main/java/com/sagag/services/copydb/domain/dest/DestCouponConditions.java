...
@NamedQuery(name = "DestCouponConditions.findAll", query = "SELECT c FROM DestCouponConditions c")
@Data
public class DestCouponConditions implements Serializable {

  private static final long serialVersionUID = -1399872287017925259L;

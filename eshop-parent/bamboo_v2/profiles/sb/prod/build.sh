...
yarn run build--wt-sb-prod

echo "Packaging WINT Serbia web"
cd ../../../../
mvn -U clean install -Dmaven.test.skip=true -Pprod -Dbuild.customer=sb
...
yarn run build--sb-prod
cd ../../../../
pwd
ls
mvn clean install -Dmaven.test.skip=true -Pprod -Dbuild.customer=sb
cd ../

#!/usr/bin/env bash
##
## The build scripts for CH PRE env
##
...
yarn run build--ddch-pre

echo "Packaging Derendinger CH web"
cd ../../../../
mvn clean install -Dmaven.test.skip=true -Ppre -Dbuild.customer=ch
cd ../

#!/usr/bin/env bash
##
## The build scripts for CH DEVELOPMENT env
##
...
yarn run build--ddch-dev

echo "Packaging Derendinger CH web"
cd ../../../../
mvn clean install -Dmaven.test.skip=true -Pdev -Dbuild.customer=ch
cd ../

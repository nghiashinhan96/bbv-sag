...
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-backoffice/target/eshop-backoffice-1.0-SNAPSHOT.war" "$bamboo_sag_tomcat_host/manager/text/deploy?path=/bo-ch-ax&update=true"

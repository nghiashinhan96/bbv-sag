...
############################ Build Autonet Eshop Web Front-End ####################################
...
cd ../../../../
mvn clean install -Dmaven.test.skip=true -Pdev -Dbuild.customer=autonet
cd ../
...
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host/manager/text/undeploy?path=/rest-autonet"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host/manager/text/undeploy?path=/auth-server"

curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host/manager/text/undeploy?path=/autonet"

...
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-web/st-cz.war" "$bamboo_sag_tomcat_host/manager/text/deploy?path=/$bamboo_st_cz&update=true"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-web/eh.war" "$bamboo_sag_tomcat_host/manager/text/deploy?path=/$bamboo_eh_st_cz&update=true"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-backoffice/bo-st.war" "$bamboo_sag_tomcat_host/manager/text/deploy?path=/$bamboo_bo&update=true"

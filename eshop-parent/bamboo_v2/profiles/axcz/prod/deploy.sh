...
do
  ...
  curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-web/ax-cz.war" "$tomcat/manager/text/deploy?path=/$bamboo_ax_cz&update=true"
  curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-backoffice/bo-ax-cz.war" "$tomcat/manager/text/deploy?path=/$bamboo_bo&update=true"
  curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-web/eh.war" "$tomcat/manager/text/deploy?path=/$bamboo_eh_cz&update=true"
done

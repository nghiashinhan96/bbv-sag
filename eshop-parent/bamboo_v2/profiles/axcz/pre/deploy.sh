...
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-web/ax-cz.war" "$bamboo_sag_tomcat_host/manager/text/deploy?path=/$bamboo_ax_cz&update=true"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-backoffice/bo-ax-cz.war" "$bamboo_sag_tomcat_host/manager/text/deploy?path=/$bamboo_bo&update=true"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password --upload-file "eshop-web/eh.war" "$bamboo_sag_tomcat_host/manager/text/deploy?path=/$bamboo_eh_cz&update=true"

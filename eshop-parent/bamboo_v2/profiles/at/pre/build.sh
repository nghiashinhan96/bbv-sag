...
yarn run build--ddat-pre

echo "Packaging Derendinger AT web"
cd ../../../../
mvn -U clean install -Dmaven.test.skip=true -Ppre
cd ../
...
yarn run build--at-pre
cd ../../../../
mvn clean install -Dmaven.test.skip=true -Ppre -Dbuild.customer=at
cd ../
...
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host_1/manager/text/undeploy?path=/auth-server-ax"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host_1/manager/text/undeploy?path=/rest-at-ax"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host_1/manager/text/undeploy?path=/dvse-ax"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host_1/manager/text/undeploy?path=/admin-ax"

curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host_1/manager/text/undeploy?path=/dat-ax"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host_1/manager/text/undeploy?path=/mat-ax"
curl -u $bamboo_sag_tomcat_user:$bamboo_sag_tomcat_password "$bamboo_sag_tomcat_host_1/manager/text/undeploy?path=/bo-ax"

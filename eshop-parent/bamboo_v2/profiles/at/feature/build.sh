#!/usr/bin/env bash
##
## The build scripts for AT FEATURE env
##
...
yarn run build--ddat-feature

echo "Packaging Derendinger AT web"
cd ../../../../
mvn clean install -Dmaven.test.skip=true -Pfeature -Dbuild.customer=at
cd ../

...
public class ArrayOfLinkedItemsCollection {

    @XmlElement(name = "LinkedItemsCollection", nillable = true)
    protected List<LinkedItemsCollection> linkedItemsCollection;
     ...
     * {@link LinkedItemsCollection }
     * 
     * 
     */
    public List<LinkedItemsCollection> getLinkedItemsCollection() {
        if (linkedItemsCollection == null) {
            linkedItemsCollection = new ArrayList<LinkedItemsCollection>();
        }

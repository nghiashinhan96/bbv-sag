...
public class ArrayOfErpInformation {

    @XmlElement(name = "ErpInformation", nillable = true)
    protected List<ErpInformation> erpInformation;
     ...
     * 
     */
    public List<ErpInformation> getErpInformation() {
        if (erpInformation == null) {
            erpInformation = new ArrayList<ErpInformation>();
        }

...
public class AxVatTypeDisplaySettingsServiceImplTest {
  ...
  public void findSettingsByOrgShortnameShouldReturnDefaultValue() {
    ...
    Assert.assertEquals(result.get().getSettingValue(),
  ...
  public void findSettingsByOrgShortnameShouldReturnValue() {
    ...
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals(result.get().getSettingValue(), value);
  }

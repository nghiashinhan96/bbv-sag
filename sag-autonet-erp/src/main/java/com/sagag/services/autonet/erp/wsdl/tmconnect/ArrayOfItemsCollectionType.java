...
public class ArrayOfItemsCollectionType {

    @XmlElement(name = "ItemsCollection", nillable = true)
    protected List<ItemsCollectionType> itemsCollection;
     ...
     * {@link ItemsCollectionType }
     * 
     * 
     */
    public List<ItemsCollectionType> getItemsCollection() {
        if (itemsCollection == null) {
            itemsCollection = new ArrayList<ItemsCollectionType>();
        }

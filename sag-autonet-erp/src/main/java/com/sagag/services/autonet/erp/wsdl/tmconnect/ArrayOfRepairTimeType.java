...
public class ArrayOfRepairTimeType {

    @XmlElement(name = "RepairTime", nillable = true)
    protected List<RepairTimeType> repairTime;
     ...
     * 
     */
    public List<RepairTimeType> getRepairTime() {
        if (repairTime == null) {
            repairTime = new ArrayList<RepairTimeType>();
        }

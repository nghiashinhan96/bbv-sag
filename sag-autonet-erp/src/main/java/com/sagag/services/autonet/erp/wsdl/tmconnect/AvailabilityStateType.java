...
public class AvailabilityStateType
    extends BaseDtoType
{
    ...
    protected JAXBElement<EntityLinkType> icon;
     ...
     *     
     */
    public JAXBElement<EntityLinkType> getIcon() {
        return icon;
    }
     ...
     *     
     */
    public void setIcon(JAXBElement<EntityLinkType> value) {
        this.icon = value;
    }

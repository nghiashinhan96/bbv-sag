    ...
    extends BaseDtoType
{
    ...
    @XmlElementRef(name = "Quantities", namespace = "http://topmotive.eu/TMConnect", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfQuantityType> quantities;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfQuantityType }{@code >}
     *     
     */
    public JAXBElement<ArrayOfQuantityType> getQuantities() {
        return quantities;
    }
     ...
     *     
     */
    public void setQuantities(JAXBElement<ArrayOfQuantityType> value) {

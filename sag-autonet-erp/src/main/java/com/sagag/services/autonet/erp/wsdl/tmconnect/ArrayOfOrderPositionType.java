...
public class ArrayOfOrderPositionType {

    @XmlElement(name = "OrderPosition", nillable = true)
    protected List<OrderPositionType> orderPosition;
     ...
     * {@link OrderPositionType }
     * 
     * 
     */
    public List<OrderPositionType> getOrderPosition() {
        if (orderPosition == null) {
            orderPosition = new ArrayList<OrderPositionType>();
        }

...
public class ArrayOfAdditionalIdentifierType {

    @XmlElement(name = "AdditionalIdentifier", nillable = true)
    protected List<AdditionalIdentifierType> additionalIdentifier;
     ...
     * 
     */
    public List<AdditionalIdentifierType> getAdditionalIdentifier() {
        if (additionalIdentifier == null) {
            additionalIdentifier = new ArrayList<AdditionalIdentifierType>();
        }

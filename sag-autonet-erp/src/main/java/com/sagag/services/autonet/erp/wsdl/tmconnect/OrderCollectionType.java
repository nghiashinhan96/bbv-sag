...
public class OrderCollectionType
    extends BaseDtoType
{
    ...
    protected JAXBElement<ArrayOfOrderType> orders;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOrderType }{@code >}
     *     
     */
    public JAXBElement<ArrayOfOrderType> getOrders() {
        return orders;
    }
     ...
     *     
     */
    public void setOrders(JAXBElement<ArrayOfOrderType> value) {
        this.orders = value;
    }

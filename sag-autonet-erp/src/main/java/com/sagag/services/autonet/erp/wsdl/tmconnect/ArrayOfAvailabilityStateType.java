...
public class ArrayOfAvailabilityStateType {

    @XmlElement(name = "AvailabilityState", nillable = true)
    protected List<AvailabilityStateType> availabilityState;
     ...
     * {@link AvailabilityStateType }
     * 
     * 
     */
    public List<AvailabilityStateType> getAvailabilityState() {
        if (availabilityState == null) {
            availabilityState = new ArrayList<AvailabilityStateType>();
        }

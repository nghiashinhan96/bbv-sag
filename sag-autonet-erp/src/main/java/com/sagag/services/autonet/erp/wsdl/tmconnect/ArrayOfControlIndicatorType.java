...
public class ArrayOfControlIndicatorType {

    @XmlElement(name = "ControlIndicator", nillable = true)
    protected List<ControlIndicatorType> controlIndicator;
     ...
     * 
     */
    public List<ControlIndicatorType> getControlIndicator() {
        if (controlIndicator == null) {
            controlIndicator = new ArrayList<ControlIndicatorType>();
        }

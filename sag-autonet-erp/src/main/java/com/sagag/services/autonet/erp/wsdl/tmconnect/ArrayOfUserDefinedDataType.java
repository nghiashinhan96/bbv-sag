...
public class ArrayOfUserDefinedDataType {

    @XmlElement(name = "UserDefinedData", nillable = true)
    protected List<UserDefinedDataType> userDefinedData;
     ...
     * {@link UserDefinedDataType }
     * 
     * 
     */
    public List<UserDefinedDataType> getUserDefinedData() {
        if (userDefinedData == null) {
            userDefinedData = new ArrayList<UserDefinedDataType>();
        }

...
@XmlSeeAlso({
    SendOrderDocumentRequestType.class,
    GetErpInformationRequestType.class,
    GetUserRequestType.class,
    SendOrderRequestType.class,
    FindItemsRequestType.class,
    GetItemsCollectionRequestType.class,
    GetNotificationRequestType.class
})

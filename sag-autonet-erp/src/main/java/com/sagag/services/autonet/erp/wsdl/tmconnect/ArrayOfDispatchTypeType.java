...
public class ArrayOfDispatchTypeType {

    @XmlElement(name = "DispatchType", nillable = true)
    protected List<DispatchTypeType> dispatchType;
     ...
     * {@link DispatchTypeType }
     * 
     * 
     */
    public List<DispatchTypeType> getDispatchType() {
        if (dispatchType == null) {
            dispatchType = new ArrayList<DispatchTypeType>();
        }

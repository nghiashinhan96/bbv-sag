...
public class ArrayOfProductGroupTmfType {

    @XmlElement(name = "ProductGroupTmf", nillable = true)
    protected List<ProductGroupTmfType> productGroupTmf;
     ...
     * {@link ProductGroupTmfType }
     * 
     * 
     */
    public List<ProductGroupTmfType> getProductGroupTmf() {
        if (productGroupTmf == null) {
            productGroupTmf = new ArrayList<ProductGroupTmfType>();
        }

...
import { FROM_SOURCE, HISTORY_SEARCH_MODE } from '../../enums/search-history.enums';
import { HistorySearchRequest } from '../../models/vehicle-history-search-request.model';
import { VehicleSearchService } from '../../services/vehicle-search.service';

@Component({
    selector: 'autonet-search-history-modal',
...
export class SearchHistoryModalComponent implements OnInit, OnDestroy {
    ...
    private readonly ASC_LOWERCASE = 'asc';
    ...
    buildColumns() {
        ...
        this.columns = [
            ...
            {
                id: 'searchTerm',
                i18n: 'COMMON_LABEL.COLUMNS.KEYWORD',
                sortable: false,
                filterable: true,
                width: '300px',
            ...
            {
                id: 'selectDate',
                i18n: 'COMMON_LABEL.COLUMNS.DATE',
                sortable: true,
                filterable: false,
                type: 'date',
            ...
            {
                id: 'fullName',
                i18n: 'COMMON_LABEL.COLUMNS.USERNAME',
                sortable: false,
                filterable: true,
    ...
    async searchHistory(page?) {
        ...
        const spinner = SpinnerService.start('autonet-search-history-modal .modal-body');
    ...
    async getFilterData(requestPage?) {
        ...
        if (sort) {
            // Only sort by date
            this.historyRequest.orderDescBySelectDate = sort.direction !== this.ASC_LOWERCASE;
        }
        if (filter) {

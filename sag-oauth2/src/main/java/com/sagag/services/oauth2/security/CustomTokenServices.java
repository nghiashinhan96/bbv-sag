...
public class CustomTokenServices implements AuthorizationServerTokenServices,
  ...
  private static final String MSG_INVALID_ACCESS_TOKEN = "Invalid access token: ";

  private int refreshTokenValiditySeconds = 60 * 60 * 24 * 30; // default 30 days.

  private int accessTokenValiditySeconds = 60 * 60 * 8; // default 8 hours.
  ...
  public OAuth2Authentication loadAuthentication(String accessTokenValue) {
    ...
    if (accessToken == null) {
      throw new InvalidTokenException(MSG_INVALID_ACCESS_TOKEN + accessTokenValue);
  ...
  public String getClientId(String tokenValue) {
    ...
    if (authentication == null) {
      throw new InvalidTokenException(MSG_INVALID_ACCESS_TOKEN + tokenValue);
    }

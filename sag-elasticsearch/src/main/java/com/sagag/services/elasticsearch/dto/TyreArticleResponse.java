...
@NoArgsConstructor
@AllArgsConstructor
public class TyreArticleResponse implements IArticleResponseSupport {
  ...
  public boolean allowViewArticles() {
    return hasArticles() && totalArticles() <= TyreConstants.VIEW_TYRE_ARTICLES_MAX_PAGE_SIZE;
  }
  ...
  public static TyreArticleResponse empty() {
    return TyreArticleResponse.builder().articles(Page.empty())
      .build();
  }

...
public class CouponMinimumOrderAmountValidatorTest {

  @InjectMocks
  private CouponMinimumOrderAmountValidator validator;
  ...
  public static CouponValidationData getValidData() {
    ...
    conditions.setMinimumOrderAmount(200.00);
  ...
  public static CouponValidationData getInvalidData() {
    ...
    cart.setItems(Arrays.asList(cartItem));
    CouponConditions conditions = new CouponConditions();
    conditions.setMinimumOrderAmount(500.00);

...
@Slf4j
public class MissingOfferAddressMigrationByCustomerStep
  extends AbstractMissingOfferSimpleStep<Long, Set<OfferAddress>> {

  @Autowired
  private OfferAddressMigrationByCustomerStep step;

  @Override
  public SimpleStepBuilder<Long, Set<OfferAddress>> stepBuilder() {
    return stepBuilder("MissingOfferAddressMigrationByCustomerStep");
  }

  @Bean("MissingOfferAddressMigrationByCustomerStepItemReader")
  @StepScope
  @Override
  ...
  @Bean("MissingOfferAddressMigrationByCustomerStepItemProcessor")
  @StepScope
  @Override
  ...
  @Bean("MissingOfferAddressMigrationByCustomerStepItemWriter")
  @StepScope
  @Override

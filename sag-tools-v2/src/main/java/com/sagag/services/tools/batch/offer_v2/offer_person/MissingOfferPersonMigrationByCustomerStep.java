...
@Slf4j
public class MissingOfferPersonMigrationByCustomerStep
    extends AbstractMissingOfferSimpleStep<SourcePerson, TargetOfferPerson> {

  @Autowired
  private OfferPersonMigrationByCustomerStep step;

  @Override
  public SimpleStepBuilder<SourcePerson, TargetOfferPerson> stepBuilder() {
    return stepBuilder("MissingOfferPersonMigrationByCustomerStep");
  }

  @Bean("MissingOfferPersonMigrationByCustomerStepItemReader")
  @StepScope
  @Override
  ...
  @Bean("MissingOfferPersonMigrationByCustomerStepItemProceesor")
  @StepScope
  @Override
  ...
  @Bean("MissingOfferPersonMigrationByCustomerStepItemWriter")
  @StepScope
  @Override

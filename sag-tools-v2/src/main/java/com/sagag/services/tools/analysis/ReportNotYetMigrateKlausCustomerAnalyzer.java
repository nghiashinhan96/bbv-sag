...
@StepScope
@Slf4j
public class ReportNotYetMigrateKlausCustomerAnalyzer extends AbstractTasklet {
  ...
  public RepeatStatus execute(StepContribution contribution,
    ...
    List<CsvCustomerInfoData> csvCustomerInfoItems = CsvUtils.read(file, CsvCustomerInfoData.class);

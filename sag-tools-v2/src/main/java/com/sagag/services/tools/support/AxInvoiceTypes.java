...
public final class AxInvoiceTypes {
  ...
  public static final String AX_WOCHENFAGE = "WOCHENFAGE";

  public static final String AX_DEFAULT = "DEFAULT";

  public static final String AX_ALL = "ALLE";

  public static final String AX_ALLESAM = "ALLESAM";
}

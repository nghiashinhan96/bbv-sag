...
public class GetSessionRequestBody {
    ...
    @XmlElementRef(name = "username", namespace = "DVSE.WebApp.CISService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> username;
    @XmlElementRef(name = "password", namespace = "DVSE.WebApp.CISService", type = JAXBElement.class, required = false)

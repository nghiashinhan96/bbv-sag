    ...
    extends BaseDto
{
    ...
    protected JAXBElement<ArrayOfOrderPosition> items;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOrderPosition }{@code >}
     *     
     */
    public JAXBElement<ArrayOfOrderPosition> getItems() {
        return items;
    }
     ...
     *     
     */
    public void setItems(JAXBElement<ArrayOfOrderPosition> value) {
        this.items = value;
    }

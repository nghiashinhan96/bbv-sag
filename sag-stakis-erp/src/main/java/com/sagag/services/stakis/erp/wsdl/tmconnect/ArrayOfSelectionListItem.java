...
public class ArrayOfSelectionListItem {

    @XmlElement(name = "SelectionListItem", nillable = true)
    protected List<SelectionListItem> selectionListItem;
     ...
     * {@link SelectionListItem }
     * 
     * 
     */
    public List<SelectionListItem> getSelectionListItem() {
        if (selectionListItem == null) {
            selectionListItem = new ArrayList<SelectionListItem>();
        }

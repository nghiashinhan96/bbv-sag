export class OilFilter {
    ...
    constructor(data?: any) {
        if (data) {
            ...
            this.aggregates = data.aggregates ? [...this.aggregates, data.aggregate] : [];
            this.viscosities = data.viscosities ? [...this.viscosities, data.viscosity] : [];
            this.bottleSizes = data.bottleSizes ? [...this.bottleSizes, data.bottleSize] : [];
            this.approvedList = data.approved ? [...this.approvedList, data.approved] : [];
            this.specifications = data.specifications ? [...this.specifications, data.specification] : [];

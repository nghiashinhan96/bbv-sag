...
@Component
@IncentiveProfile
public class ChBigPointLinkGeneratorImpl extends BigPointLinkGeneratorImpl {
  ...
  public IncentiveMode support(SupportedAffiliate affiliate, boolean showHappyPoints) {
    if (showHappyPoints && affiliate != null && affiliate.isMatikCh()) {
      return IncentiveMode.BIG_POINTS;
    }
    return null;
  }
  ...
  public String generate(IncentiveLoginDto login) throws CookiePrivacyException {
    return generate(login, incentiveProps.getBigPoints());
  }

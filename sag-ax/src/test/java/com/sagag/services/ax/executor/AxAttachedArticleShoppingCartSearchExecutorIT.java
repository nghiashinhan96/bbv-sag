...
@Slf4j
public class AxAttachedArticleShoppingCartSearchExecutorIT {
  ...
  public void shouldExecuteWithDupplicateDepotArticleButDifferentQuantity() {
    ...
    attachedArticleRequestList
        .add(new AttachedArticleRequest("1001420930", 2, 1, "cartKey_1", 0d));
    attachedArticleRequestList
        .add(new AttachedArticleRequest("1001420930", 5, 1, "cartKey_2", 0d));

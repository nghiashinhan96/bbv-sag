...
public class AxCustomerException extends AxExternalException {
  ...
  public static AxCustomerException buildBlockedCustomerException(String reason) {
    return new AxCustomerException(AxCustomerErrorCase.AC_BLOCKED_CUSTOMER_001, reason);
  }
  ...
  public enum AxCustomerErrorCase implements IBusinessCode, IAxErrorMatcher {
    ...
    AC_SEND_METHOD_002("UN_SUPPORT_SEND_METHOD") {
      @Override
      public boolean isMatchError(RestClientResponseException ex) {
        throw new UnsupportedOperationException();
      }
    ...
    AC_BLOCKED_CUSTOMER_001("BLOCKED_CUSTOMER") {
      @Override
      public boolean isMatchError(RestClientResponseException ex) {
        throw new UnsupportedOperationException();
      }
